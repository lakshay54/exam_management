                ...
                <div className="bodyUploadBox">
                    ...
                    <div className="rightBodyContentBox">
                        <div className="rightBodyContent">
                            <h4 style={{marginBottom:"10px", fontFamily:"Verdana"}}>Generate Time Table</h4>
                            <a href="http://localhost:8800/download"><Button variant="success" className="customButton1">Generate And Download</Button></a>          
                        </div>
                    </div>
                </div>
        </div>
